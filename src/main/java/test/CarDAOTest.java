...
public class CarDAOTest {
	...
	public void addTest() {
		...
		Car car = new Car(id, name, available, imageUrl, true, kilometers, brand, state, maxSpeed, numberOfSpeeds,
				model, power, registrationNumber, renewalKilometers, numberOfSeats);
